		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(comboBox.getSelectedItem()=="Paytm")
					...
					try {
						Desktop.getDesktop().browse(new URI("https://paytm.com/metro-card-recharge"));;
					}catch(Exception err) {}
				...
				if(comboBox.getSelectedItem()=="Google pay")
					try {
						Desktop.getDesktop().browse(new URI("https://pay.google.com/intl/en_in/about/?gclid=CjwKCAiAlrSPBhBaEiwAuLSDUDrmjmIZxZQ_EdFTqLhRLh5tGN6m0zmb7vo-C53WpGYvDB6PmTTIghoCTX8QAvD_BwE&gclsrc=aw.ds"));;
					}catch(Exception err) {}
